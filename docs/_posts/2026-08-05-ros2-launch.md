...
author: 老张同志
excerpt: "从零掌握 ROS2 Python launch 文件：核心概念、基础启动、多节点隔离、启动参数、条件启动、launch 安装配置、launch 互相调用、高级用法（ExecuteProcess / TimerAction），附常用字段速查表。"
---
# ROS2 的 launch 文件
...
# ROS2 参数文件的格式：最外层是"节点全名"，下面固定是 ros__parameters 键
