...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            executable='turtlesim_node',  # 可执行文件名（CMakeLists.txt 中 add_executable 的名字）
        ),
    ])
```
...
def generate_launch_description():
    return LaunchDescription([
        launch_ros.actions.Node(
            ...
            namespace='turtlesim1',       # 通过 namespace 隔离，两个同类型节点可以共存
            name='turtle1',
        ...
        launch_ros.actions.Node(
            ...
            name='turtle1',
            parameters=[{'background_r': 0, 'background_g': 255, 'background_b': 100}],
        ),
    ])
```
