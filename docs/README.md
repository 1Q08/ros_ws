...
An open-source **ROS 1 / ROS 2 command-line reference tool** built with Jekyll + GitHub Pages, featuring an interactive command browser.

> This site is generated by open-source AI models (Kimi K3, Claude Opus 4.8, Deepseek V4, etc.). Content is for reference only; please contact the author if you find any errors.
...
<p align="center">
  <h3 align="center">ROS Command Reference</h3>
  <p align="center">
    An open-source ROS 1 / ROS 2 command-line reference with an interactive browser, bilingual UI, and dark/light themes.
    <br />
...
- [Command Reference Page](#command-reference-page)
