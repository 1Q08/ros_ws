...
<p align="center">An open-source **ROS 1 / ROS 2 command-line reference tool** built with Jekyll + GitHub Pages, featuring an interactive command browser with bilingual support and dark/light themes.</p>
