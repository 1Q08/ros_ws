...
setup(
    ...
    version='0.0.0',                           # 版本号：遵循语义化版本（major.minor.patch）
    ...
    maintainer_email='19872205914@163.com',  # 维护者邮箱
    description='TODO: Package description', # 包的功能用途描述
    license='TODO: License declaration',     # 开源协议声明
    ...
    entry_points={
        'console_scripts': [
            # 注册可执行命令：ros2 run my_package my_node
